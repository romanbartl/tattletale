...
public abstract class AbstractReport implements Report
{
   ...
   public void writeHtmlHead(BufferedWriter bw) throws IOException
   {
	 ...
	 // bw.write("<?xml-stylesheet type=\"text/css\" href=\"styl.css\"?>"+ Dump.newLine());
	  bw.write(" <!---  to je snad komentar v an -->      ");
      bw.write("<main>" + Dump.newLine());
      bw.write("<info>" + Dump.newLine());
      bw.write("  <h3>" + Version.FULL_VERSION + ": " + getName() + "</h3>" + Dump.newLine());
      bw.write("</info>" + Dump.newLine());
   }
